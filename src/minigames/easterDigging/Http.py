...
class Http:
    ...
    def init_game(self):
        try:
            ...
            Logger().print_exception('Failed to init easter digging')
            return None
    ...
    def hit(self, zone: int):
        try:
            ...
            Logger().print_exception('Failed to hit zone in easter digging')
            return None
    ...
    def finish_game(self):
        try:
            ...
            Logger().print_exception('Failed to finish easter digging')
            return None